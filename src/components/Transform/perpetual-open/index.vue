  ...
  <div id="cryptos">
    <div class="perpetual-open">
      ...
      <div class="pt-30 pb-20">
        <div class="flex">
          <!-- 港股隐藏 -->
          <div class="flex flex-col" :class="queryType !== 'HK-stocks' ? 'w-440' : 'w-full'">
            ...
            <div class="flex items-center greyBg h-76 lh-76 rounded-lg"
              :class="queryType !== 'HK-stocks' ? 'w-440' : 'w-full'" v-if="initFutrue">
              ...
              <input v-if="selectIndex == 1" :placeholder="$t('张数')" class="border-none greyBg text-center textColor"
                :class="queryType !== 'HK-stocks' ? 'half-input' : 'full-input'" v-model="form.amount" type="number"
                @input="onInput" />
    ...
    'USDT' : 'USD' }}</div>
            ...
            <template v-if="userInfo.token">
              ...
              <template v-if="selectIndex == 2">
                <div class="w-full h-80 lh-80 bg-green flex text-white rounded-md mt-10 " @click="throttleFn('open')"
                  v-if="userInfo.token">
                ...
                <div class="w-full h-80 lh-80 bg-red flex text-white rounded-md mt-20 mb-10" style="position: relative;"
                  :class="{ 'mt-22': selectIndex == 2 }" @click="throttleFn('close')" v-if="userInfo.token">
          ...
          <div class="ml-30" v-if="queryType !== 'HK-stocks'">
            ...
            <div class="flex k-select-box">
              <div class="mt-2 mb-2 select-box" style="position: relative">
                ...
                <div class="option-box" v-show="arryIsShow">
                  <div class="font-28" v-for="(item, index) in selectDataArry" :key="index" @click="selectItemArry(item)">
                    {{ item.name }}
                  </div>
                </div>
              </div>
