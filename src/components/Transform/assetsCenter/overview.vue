<template>
  <div class="box-border">
      ...
      <div class="flex justify-between text-grey relative">
        <div class="flex items-center">
          ...
          <div @click.stop="changeEyes">
            <img
              src="../../../assets/image/assets-center/eye-open.png"
              class="w-32 h-18"
              v-show="!eyetel"
            />
            <img
              src="../../../assets/image/assets-center/eye-close.png"
              class="w-32 h-18"
              v-show="eyetel"
            />
          </div>
        ...
        <div class="right-clock" @click="goRouter('/cryptos/exchangeHistory')">
          <img
            src="../../../assets/image/assets-center/Subtract.png"
            class="subtract-icon"
          />
        </div>
      </div>
    ...
    <div class="pl-33 pr-33 btn-box flex justify-between">
      <div
        class="font-25 textColor tabBackground"
        @click="goRouter('/cryptos/recharge/rechargeList')"
      >
        <div class="word-wrap">
      ...
      <div
        class="font-25 textColor tabBackground"
        @click="goRouter('/cryptos/exchangePage')"
      >
        <div class="word-wrap">
    ...
    <div class="pl-30 pr-30">
      ...
      >
        <div class="items-center">
          <img :src="item.img" class="w-44 h-44" />
