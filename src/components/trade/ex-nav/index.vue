  ...
  data() {
    return {
      ...
      pathList: {
        ...
        cryptos: {
          [this.$t('买入')]: '/cryptos/perpetualContract/btc?tabActive=0&from=trade',
          [this.$t('卖出')]: '/cryptos/perpetualContract/btc?tabActive=1&from=trade',
        ...
        'forex': {
          [this.$t('买入')]: '/foreign/coinChart?symbol=XAUUSD&tabActive=0&from=trade',
          [this.$t('卖出')]: '/foreign/coinChart?symbol=XAUUSD&tabActive=1&from=trade',
