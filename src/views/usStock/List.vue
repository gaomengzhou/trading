    ...
    <div class="container-box">
      ...
      <section class="tab-container">
        <section class="etf-container">
          ...
          <div class="nav">
            <us-stock-ex-nav :prominentListData="prominentListData" />
          </div>
...
const itemClick = (item) => {
  router.push(`/quotes/usStockDetail?symbol=${item.symbol}&symbolType=US-stocks&enName=${item.enName}`)
}
//打开更多
const moreOpen = (index, name) => {
  router.push(`/quotes/UsStockMore?index=${index}&typName=${name}&symbolType=US-stocks`)
}
</script>
