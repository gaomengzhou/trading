<template>
  <div class="register">
    ...
    <ExInput
      :label="$t('setPassword')"
      :placeholderText="$t('passwordTips')"
      v-model="password"
      typeText="password"
    />
    <ExInput
      :label="$t('repassword')"
      :placeholderText="$t('surePassword')"
      v-model="repassword"
      typeText="password"
    />
    <ExInput
      :label="$t('setSafeword')"
      :placeholderText="$t('safewordTips')"
      v-model="safeword"
      typeText="password"
      v-if="activeIndex === 1"
    />
    ...
    <ExInput
      :label="$t('invitCode')"
      :placeholderText="$t('entryInvitCode')"
      v-model="invitCode"
      :clearBtn="false"
    />
    <div class="protocol textColor">
      ...
      {{ $t("readAgree")
      }}<span class="colorMain" @click="router.push('/TermsOfService')">{{
        $t("serviceConf")
      }}</span>
    </div>
    <van-button class="w-full" style="margin-top: 10px" type="primary" @click="register"
      >{{ $t("register") }}
    </van-button>
