      ...
      <section class="tab-container">
        <section class="etf-container">
          <div class="indicator-container flex">
            ...
            }" v-for="(item, index) in indexCardInfo" :key="item" @click="handleIndexClick(item, index)">
              <div class="title-box">
                <div class="point"></div>
            ...
            <div class="px-12">
              <van-notice-bar class="font-26 textColor" left-icon="" :scrollable="false" background="transparent">
                <div slot="left-icon" class="flex items-center more-img">
                  <img class="w-20 h-20 more-img" src="../../assets/Horn.png" alt="" />
                </div>
                ...
                <div class="ml-20 flex items-center" slot="right-icon" @click.stop="$router.push('/cryptos/announce')">
                  <img class="w-20 h-20 more-img" src="../../assets/more.png" alt="" />
                </div>
              </van-notice-bar>
            </div>
          </section>
    ...
    : "--"
          ...
          <div class="all-etf-ranking">
            ...
            <div class="etf-table">
              <ul>
                ...
                <li v-for="(item, index) in hkStocksListData" :key="item.symbol" @click="itemClick(item)">
                  <div class="flex-l">
                    <p>{{ item.name }}</p>
                    <p class="gray-text">
                      {{ item.symbol }}
          ...
          <div class="technology" v-if="technologyListData && technologyListData.length > 0">
            ...
            <div class="other-etf-ranking">
              ...
              <div class="more-box" v-if="technologyListData.length > 5" @click="moreOpen(1, t('Technology'))">
                <div class="icon-group">
                  <p class="">{{ t("更多") }}</p>
                  <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                </div>
          ...
          <div class="financial" v-if="dinancialListData && dinancialListData.length > 0">
            ...
            <div class="other-etf-ranking">
              ...
              <div class="more-box" v-if="dinancialListData.length > 5" @click="moreOpen(2, t('Financial'))">
                <div class="icon-group">
                  <p class="">{{ t("更多") }}</p>
                  <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                </div>
          ...
          <div class="medicineAndfood" v-if="healthcareListData && healthcareListData.length > 0">
            ...
            <div class="other-etf-ranking">
              ...
              <div class="more-box" v-if="healthcareListData.length > 5" @click="moreOpen(3, t('MedicineAndfood'))">
                <div class="icon-group">
                  <p class="">{{ t("更多") }}</p>
                  <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                </div>
          ...
          <div class="autoEnergy" v-if="energyListData && energyListData.length > 0">
            ...
            <div class="other-etf-ranking">
              ...
              <div class="more-box" v-if="energyListData.length > 5" @click="moreOpen(4, t('AutoEnergy'))">
                <div class="icon-group">
                  <p class="">{{ t("更多") }}</p>
                  <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                </div>
          ...
          <div class="manufacturingRetaiSales" v-if="manufacturingListData && manufacturingListData.length > 0">
            ...
            <div class="other-etf-ranking">
              ...
              <div class="more-box" v-if="manufacturingListData.length > 5"
                @click="moreOpen(5, t('ManufacturingRetaiSales'))">
                <div class="icon-group">
                  <p class="">{{ t("更多") }}</p>
                  <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                </div>
          ...
          <div class="chineseStocks" v-if="chineseListData && chineseListData.length > 0">
            ...
            <div class="other-etf-ranking">
              ...
              <div class="more-box" v-if="chineseListData.length > 5" @click="moreOpen(6, t('ChineseStocks'))">
                <div class="icon-group">
                  <p class="">{{ t("更多") }}</p>
                  <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                </div>
          ...
          <div v-for="listData in newTypeArr" v-if="newTypeArr.length > 0">
            <div :class="listData.name" v-if="listData.value && listData.value.length > 0">
              ...
              <div class="other-etf-ranking">
                ...
                <div class="more-box" v-if="listData.length > 5" @click="moreOpen(listData.index, t(item.name))">
                  <div class="icon-group">
                    <p class="">{{ t("更多") }}</p>
                    <img src="@/assets/image/quotes/right-arrow-grey.png" alt="" class="icon arrow" />
                  </div>
...
<script setup>
import { ref, onMounted, onBeforeMount, nextTick, onUnmounted } from "vue";
...
const tabList = ref([
  { title: t("涨幅榜"), value: "gains" },
  { title: t("跌幅榜"), value: "decline" },
  { title: t("成交量"), value: "afterHours" },
  { title: t("成交额"), value: "preMarket" },
]);
...
const getHotModule = () => {
  _getETFItemList({
    type: "HK-stocks",
    symbol: "00700,09988,02269"
  }).then((data) => {
    if (data === null) {
      data = [];
    }
    hkHotModule.value = data;
  })
}

const getETFItemList = () => {
  _getHkStocksItemList({
    type: "HK-stocks",
    scene: scene.value,
  }).then((data) => {
    if (data === null) {
...
const itemClick = (item) => {
  router.push(
    `/quotes/usStockDetail?symbol=${item.symbol}&symbolType=HK-stocks&enName=${item.enName}`
  );
};
//打开更多
const moreOpen = (index, name) => {
  router.push(`/quotes/UsStockMore?index=${index}&typName=${name}&symbolType=HK-stocks`);
};
</script>
