              ...
              <div v-for="(item, index) in list" :key="'interest' + index">
                <div class="flex justify-between items-center h-150 px-33">
                  <div class="flex items-center">
                    <img v-if="item.amount / 1 > 0 ? false : true" src="@/assets/image/assets-center/out.png"
                      alt="" class="w-44 h-44 mr-30">
                    <img v-else src="@/assets/image/assets-center/in.png" alt="" class="w-44 h-44 mr-30">
