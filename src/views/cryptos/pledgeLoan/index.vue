            ...
            <div class="contentBox">
                ...
                <div class="content mt-266 box-shad tabBackground">
                    <div class="mb-38">
                        ...
                        <div class="h-96 lh-96 pledgeLoan_background rounded-lg text-center text-black font-34"
                ...
                <div class="content mt-38 tabBackground">
                    ...
                    <div class="flex mt-20 h-96 items-center inputBox inputBackground1 textColor relative">
                        <input class="h-full pl-22 inputBackground1" type="number" v-model="pledgeAmount"
                        ...
                        <div class="right w-252 h-62 flex items-center pl-26 box-border" @click="openSelectBorrow">
                            ...
                            <span class="ml-14 mr-30 w-90 currency-title">{{ pledgeCurrency.toUpperCase() }}</span>
                            <img src="@/assets/image/icon-more.png" alt="logo" class="w-24 h-24" />
                        </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center border-b-color justify-between" v-for="item in walletList"
                                    ...
                                    <div class="flex items-center">
                                        <img :src="`${HOST_URL}/symbol/${item.symbol}.png`" class="w-40 h-40" alt="">
                    ...
                    <div class="flex items-center h-96 mt-20 inputBox inputBackground1 textColor"
                    ...
                    <div class="mt-78 h-96 lh-96 pledgeLoan_background rounded-lg text-center text-black font-34 mt-48"
                        @click="getAddOrder">
                        {{ $t('借款') }}</div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        selectCoin(item) {
            ...
            this.symbol_data = item.symbol_data
        ...
        getList() {
            _getAllWallet({ typs: 'cryptos' }).then((res) => {
