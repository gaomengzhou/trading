<template>
  <div id="cryptos">
    <div id="full" style="z-index: 100;overflow: auto;"
      ...
      <div class="pt-46 pb-30 c2cTabBg">
      ...
      <!--    </evaluation>-->
      <div class="mt-16">
        <div class="flex justify-between items-center h-100 px-32 mt-16 c2cTabBg c2cColor" @click="tokefu">
          <div>
        ...
        <div class="flex justify-between items-center h-100 px-32 mt-16 c2cTabBg c2cColor"
