    ...
    <div class="loan">
      <assets-head :title="$t('助力贷')">
        <div class="right flex items-center">
          <img
            src="@/assets/image/loan/rule.png"
            alt="rule-img"
            class="w-50 h-50 mr-20"
            @click="$router.push('/cryptos/loanRule')"
          />
          <img
            src="@/assets/image/loan/history.png"
            alt="exchange-img"
            class="w-50 h-50"
      ...
      <div class="container px-32">
        ...
        <div class="loanList">
          <div class="flex justify-between py-30 border-b-color">
            ...
            <div class="flex align-center">
              ...
              <span class="mr-14 font-600 textColor">{{ loanData.max_quota || 0 }}</span>
          ...
          <div class="flex justify-between py-30 border-b-color">
            ...
            <div class="flex items-center">
              ...
              <div
                class="font-600 mr-14 textColor relative"
                @click="isSelectDay = !isSelectDay"
              >
          ...
          <div class="flex justify-between py-30 border-b-color">
            ...
            <div class="flex align-center">
              <span class="font-600 textColor">{{ loanData.lending_name }}</span>
            </div>
          </div>
        </div>
        <!--      上传区域-->
        ...
        <!--      确认按钮-->
        <div
          class="confirmBtn btnMain w-full py-30 text-center text-white font-400 font-32"
          @click="submit()"
        >
          <span>{{ $t("确定") }}</span>
        </div>
      ...
      <van-popup v-model:show="isSelectDay" position="bottom" :round="true">
        <ul class="main2_background">
          <li
            v-for="(day, index) in loanDeployList"
