        ...
        <div class="w-full h-122 pl-40 pr-31 box-border flex text-white items-center">
          ...
          <div class="flex-1 text-right mr-100">
            <span @click="showPopup">
              <span class="font-35 font-700 mr-8 textColor">{{ $t("快捷区") }}</span>
          ...
          >
            <div
              class="flex items-center"
              @click="$router.push({ path: '/cryptos/selectLegalCurrency' })"
            >
              <span class="mr-15 font-31 font-400">{{ exchangeCurrency }}</span>
              <img
                class="w-24 h-20"
                src="@/assets/image/otc/wantBuyHead/Group.png"
                alt=""
              />
            </div>
            ...
            >
              <template #reference>
                <img
                  @click="showPopover = !showPopover"
                  class="relative w-24 h-6 list-img"
                  src="@/assets/image/otc/wantBuyHead/Group2.png"
                  alt=""
                />
              </template>
            </van-popover>
          ...
          <div v-show="order_type === 'Amount'">
            ...
            <div class="flex justify-between mt-28 font-24">
              ...
              <div class="flex items-center text-blue" @click="changeOrderType('Num')">
                ...
                <img
                  class="w-24 h-24"
                  src="../../../assets/image/c2c/Group241.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div v-show="order_type === 'Amount'">
            <div class="flex justify-between mb-18" style="color: #595c61">
              ...
              <span
                class="font-24 text-blue"
                style="text-decoration: underline"
                @click="$router.push('/cryptos/exchangePage')"
                >{{ $t("划转") }}</span
              >
            </div>
            <div class="w-full relative box-border rounded-xl inputBackground1 input">
