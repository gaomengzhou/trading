<template>
  <div id="cryptos">
    <div class="tradeRecord">
      ...
      <div class="content">
        <van-tabs v-model:active="active" class="w-full px-20 box-border" sticky @click="changeType">
          <van-tab :title="$t('当前委托')" class="font-30">
            <div class="all-select flex justify-end font-28">
