      ...
      <div class="px-32 pb-40">
        <div class="swiper">
          <div class="flex items-center ">
            <img class="w-128 h-128" :src="imgUrl" alt="">
          ...
          <div class="mt-50 flex">
            ...
            <div class="flex flex-col items-start ml-60">
              ...
              <span class="font-40 font-700 text-white mt-16">{{ data.computing_power + data.computing_power_unit
              }}</span>
            </div>
          </div>
        </div>
        <div class="mt-60 mb-20 text-color font-30 textColor">{{ $t('挖矿收益') }}</div>
        <div class="mb-40">
          ...
          <div class="mt-44 mb-20 text-color font-30 textColor">{{ $t('基础数据') }}</div>
          <div>
