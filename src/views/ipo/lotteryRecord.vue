    ...
    <div class="lotteryRecord">
        ...
        <div class="px-5">
            ...
            <div class="tab-header flex px-5 py-5 text_color6">
                ...
                <div class="flex-1 text-center">现价/成本</div>
                <div class="flex-1 text-center">持有/市场</div>
                <div class="flex-1 text-center">损益</div>
                <div class="flex-1 text-center">时间</div>
                <div class="flex-1 text-right">状态</div>
            </div>
            ...
            <div v-for="(item, index) in list" :key="index" class="list-div flex">
                <div class="flex-1">
                    <div class="list-title">Claire’s Holdi Holdi Holdi Holdi</div>
                    <div class="text_color6">PAPL</div>
                </div>
                <div class="flex-1">3.2/3.2</div>
                <div class="flex-1">3.2/3.2</div>
                <div class="flex-1">11</div>
                <div class="flex-1">2030/09/01</div>
                <div class="flex-1 text-right">成交</div>
            </div>
        </van-list>
        </div>
    </div>
