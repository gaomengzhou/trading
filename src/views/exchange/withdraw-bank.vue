<template>
  <div class="charge-bank pb-20">
    ...
    <div class="pt-6">
      ...
      <div class="flex px-4 pt-4 pb-8 justify-between ">
        ...
        <div class="money text-base">
          <span class="mr-1 font-semibold">{{ bal }}</span>
          <span>USD</span>
        </div>
      </div>
      <div class="mx-4 pb-10 pt-10 quantity-wrap">
        <div class="flex justify-between items-center">
          ...
          <div class="money">
            <span class="mr-1 text-xl font-semibold">{{ bal }}</span>
    ...
    <fx-popup v-model:show="showPopup" :payInfo="payInfo" @close="closeOrder" :fee="fee"
      :volume_last="volume_last"></fx-popup>
  </div>
</template>
