...
onMounted(async () => {
  if (localStorage.getItem('etfHotSymbol')) {
    hotSymbol.value = JSON.parse(localStorage.getItem('etfHotSymbol'))
  }
  getNewsList()
  getIndexCardInfo()
  getETFItemList()
...
const getETFItemList = () => {
  _getETFItemList({
    ...
    localStorage.setItem('etfHotSymbol', JSON.stringify(hotSymbol.value))
