<template>
  ...
  <section class="inner-tab-container">
    <div class="line-first-container flex">
      <div class="line-first flex">
        <div class="line-first-l">
          <p>
            <span>{{ t("最新价") }} {{ chartData.close }}</span>&nbsp; <span class="red">{{ chartData?.changeRatio
    ...
    <div class="orderbook-container flex justify-between px-30 py-30">
      ...
      <div class="trade-deep-data" v-if="symbolType !== 'HK-stocks'">
        <keep-alive>
      ...
      <div class="trade-deep-data" v-else>
        <div class="index-card flex-r" v-if="symbolType === 'HK-stocks'">
          <div class="flex-r-item">
            ...
            <p>
              ...
              <span class="value">{{ chartData?.turnoverRate ? formatMoney(chartData?.turnoverRate) + '%' : '-'
              }}</span>
            </p>
            <p>
    ...
    <div class="fixed-box">
      <div class="flex title justify-between items-center px-30" @click.stop="handleClickShowKlineChart()">
        <span class="font-16 textColor">{{ symbol.toUpperCase() }}&nbsp;&nbsp;{{ $t("k线图表") }}</span>
