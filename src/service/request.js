    ...
    if (error && error.request) {
      ...
      switch (status) {
        ...
        case 424:
          ...
          break
        case 404:
          showToast({ message: i18n.global.t("interfaceNotFound"), type: 'fail', duration: 2000 })
          break
        case 415:
          showToast({ message: i18n.global.t("httpProtocolMismatch"), type: 'fail', duration: 2000 })
          break
        case 428:
          showToast({ message: i18n.global.t("VerificationCodeIsIllegal"), type: 'fail', duration: 2000 })
          break
        // case 500:
        ...
        default:
          // console.log(error)
          if (error.config.url != '/api/api/hobi!getRealtime.action' || error.config.url != '/api/api/item!list.action') {
